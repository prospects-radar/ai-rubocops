...
Gem::Specification.new do |spec|
  ...
  spec.description = "Project-specific RuboCop cops enforcing DesignSystem, service layer, RAAF agent, testing, and tenant safety conventions"
  spec.license = "MIT"
  spec.required_ruby_version = ">= 3.2.0"

  spec.files = Dir.chdir(__dir__) do
    Dir["{lib}/**/*", "ai-rubocops.gemspec"]
  end
